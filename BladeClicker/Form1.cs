...
namespace BladeClicker
{
    public partial class Form1 : Form
    {
        ...
        {
            randomisedCPS = new Random().Next(Trackbar.Value - 3, Trackbar.Value + 3);
        }
        ...
        private void clicksounds_Tick(object sender, EventArgs e)
        {
            if (Checkbox.Checked)
            {
                if (MouseButtons == MouseButtons.Left)
                {
                    ...
                    click.SoundLocation = textBox1.Text;
                    click.Load();
                    click.Play();
                }
                else
        ...
        private void siticoneButton3_Click(object sender, EventArgs e)
        {
            ...
            openFileDialog1.Filter = "WAV Audio File|*.wav";
